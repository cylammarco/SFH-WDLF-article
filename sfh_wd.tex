...
Upon deriving a SFH with a WDLF, the most important unsolved problem is
``How much information can we obtain?''. We address two of these parameters
in this work: (i) the resolution of the signal in the magnitude space or a
WDLF, and (ii) the time resolution of the signal in the SFH. Any attempt
in retrieving signal at finer intervals is essentially amplifying noise.

\subsection{Effect of magnitude bin size}
Isolated WDs follows a narrow distribution of surface gravity with
...
\subsection{Optimal magnitude bin for a given magnitude resolution}
\begin{figure}
...
\subsection{Optimal time bin for a given magnitude resolution}
\begin{figure}
