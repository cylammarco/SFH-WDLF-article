...
\begin{figure}
    \includegraphics[width=\columnwidth]{figures/fig_02_magnitude_resoltuion.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure*}
    \includegraphics[width=\textwidth]{figures/fig_03_gcns_reconstructed_wdlf_optimal_resolution_bin_05.png}
    \caption{Caption}
    \label{fig:sfh_mag_bin_05}
\end{figure*}

\begin{figure*}
    \includegraphics[width=\textwidth]{figures/fig_04_gcns_reconstructed_wdlf_optimal_resolution_bin_02.png}
    \caption{Caption}
    \label{fig:sfh_mag_bin_02}
\end{figure*}
