...
(i)~two bursts, and (ii)~decaying star formation history.

\subsubsection*{Decaying star formation history}

\begin{figure}
  \dummyfig{Exponentially Decaying SFH} 
...
\begin{figure}
  ...
  \caption{The recovered SFH and reconstructed SFH of a mock stellar population with a dual-burst star formation history.}
